  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-md flex-col justify-center gap-8 px-6 py-10">
      ...
      <form onSubmit={onSubmit} className="flex flex-col gap-4">
        <div className="flex flex-col gap-1.5">
          ...
          <input
            ...
            className="rounded-lg border border-zinc-300 bg-white px-3 py-2.5 text-sm text-zinc-900 placeholder:text-zinc-400 transition focus:border-amber-400/50 focus:outline-none focus:ring-2 focus:ring-amber-400/20 dark:border-zinc-800 dark:bg-zinc-900/40 dark:text-zinc-100 dark:placeholder:text-zinc-600 dark:focus:border-amber-400/40 dark:focus:ring-amber-400/10"
          />
        </div>
        ...
        <button
          type="submit"
          disabled={loading}
          className="mt-1 rounded-lg bg-amber-400 px-4 py-2.5 text-sm font-medium text-zinc-950 shadow-lg shadow-amber-400/30 transition hover:bg-amber-300 focus:outline-none focus:ring-2 focus:ring-amber-400/40 disabled:cursor-not-allowed disabled:opacity-50 dark:shadow-amber-400/20"
        >
      ...
      <button
        ...
        className="self-start text-sm text-zinc-600 underline decoration-zinc-300 underline-offset-4 transition hover:text-zinc-900 hover:decoration-zinc-500 dark:text-zinc-400 dark:decoration-zinc-700 dark:hover:text-zinc-100 dark:hover:decoration-zinc-500"
      >
        {mode === 'signin'
